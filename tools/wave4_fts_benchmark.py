...
# needs_auth_db=False: this script only runs raw SQL against
# j2_notes/j2_notes_fts + the pure fts_match_expr() function -- it never
# calls into notes.py's service layer, so it never transitively opens
...
# notebook_sandbox_guard.py's docstring for the real near-miss this
# guards against.
