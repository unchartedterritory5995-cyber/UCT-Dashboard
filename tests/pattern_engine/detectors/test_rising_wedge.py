"""Battery test for the rising_wedge detector. Runs every fixture in
tests/fixtures/rising_wedge/ and asserts the expected outcome.

A rising wedge is a bearish reversal/continuation: both upper and lower
trendlines slope up, with the upper line rising less steeply, so the
lines converge upward toward an apex.
"""
import pytest

from api.services.pattern_engine.detectors.classical.rising_wedge import detect_rising_wedge
from api.services.pattern_engine.primitives.context import build_context
from tests.pattern_engine.detectors.fixture_loader import load_all_fixtures


FIXTURES = load_all_fixtures("rising_wedge", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_rising_wedge_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_rising_wedge(fixture.bars, ctx)
    ...
    if fixture.expected_fires:
        ...
        assert d["pattern_id"] == "rising_wedge"
