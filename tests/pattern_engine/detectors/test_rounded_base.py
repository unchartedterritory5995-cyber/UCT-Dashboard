"""Battery test for the rounded_base detector."""
import pytest

from api.services.pattern_engine.detectors.classical.rounded_base import (
    detect_rounded_base,
)
...
FIXTURES = load_all_fixtures("rounded_base", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_rounded_base_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_rounded_base(fixture.bars, ctx)
    ...
    if fixture.expected_fires:
        ...
        assert d["pattern_id"] == "rounded_base"
