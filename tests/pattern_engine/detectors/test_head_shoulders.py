"""Battery test for the head_shoulders detector. Runs every fixture in
tests/fixtures/head_shoulders/ and asserts the expected outcome.

Head and Shoulders is a 3-peak topping pattern: left shoulder, head
(highest), right shoulder. Neckline connects the two troughs between
peaks. Bearish reversal pattern.
"""
import pytest

from api.services.pattern_engine.detectors.classical.head_shoulders import detect_head_shoulders
from api.services.pattern_engine.primitives.context import build_context
from tests.pattern_engine.detectors.fixture_loader import load_all_fixtures


FIXTURES = load_all_fixtures("head_shoulders", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_head_shoulders_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_head_shoulders(fixture.bars, ctx)
    ...
    if fixture.expected_fires:
        ...
        assert d["pattern_id"] == "head_shoulders"
