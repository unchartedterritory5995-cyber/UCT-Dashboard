"""Battery test for the triple_bottom detector."""
import pytest

from api.services.pattern_engine.detectors.classical.triple_bottom import (
...
FIXTURES = load_all_fixtures("triple_bottom", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_triple_bottom_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_triple_bottom(fixture.bars, ctx)
    ...
    if fixture.expected_fires:
        ...
        assert d["pattern_id"] == "triple_bottom"
