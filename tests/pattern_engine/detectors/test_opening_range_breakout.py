"""Battery test for the Opening Range Breakout detector."""
import pytest

from api.services.pattern_engine.detectors.uct.opening_range_breakout import detect_opening_range_breakout
from api.services.pattern_engine.primitives.context import build_context
from tests.pattern_engine.detectors.fixture_loader import load_all_fixtures


FIXTURES = load_all_fixtures("opening_range_breakout", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_opening_range_breakout_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_opening_range_breakout(fixture.bars, ctx)
