"""Battery test for the symmetrical_triangle detector."""
import pytest

from api.services.pattern_engine.detectors.classical.symmetrical_triangle import (
...
FIXTURES = load_all_fixtures("symmetrical_triangle", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_symmetrical_triangle_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_symmetrical_triangle(fixture.bars, ctx)
    ...
    if fixture.expected_fires:
        ...
        assert d["pattern_id"] == "symmetrical_triangle"
