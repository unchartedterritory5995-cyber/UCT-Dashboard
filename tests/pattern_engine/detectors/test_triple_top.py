"""Battery test for the triple_top detector."""
import pytest

from api.services.pattern_engine.detectors.classical.triple_top import (
    detect_triple_top,
)
...
FIXTURES = load_all_fixtures("triple_top", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_triple_top_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_triple_top(fixture.bars, ctx)
    ...
    if fixture.expected_fires:
        ...
        assert d["pattern_id"] == "triple_top"
