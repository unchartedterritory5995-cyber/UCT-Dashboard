"""Battery test for the td_sequential_sell (DeMark TD9 mirror) detector."""
import pytest

from api.services.pattern_engine.detectors.classical.td_sequential_sell import detect_td_sequential_sell
from api.services.pattern_engine.primitives.context import build_context
from tests.pattern_engine.detectors.fixture_loader import load_all_fixtures


FIXTURES = load_all_fixtures("td_sequential_sell", include_internal=False)


@pytest.mark.parametrize("fixture", FIXTURES, ids=lambda f: f.name)
def test_td_sequential_sell_fixture(fixture):
    ctx = fixture.context if fixture.context is not None else build_context(fixture.bars, sym="TEST")
    detections = detect_td_sequential_sell(fixture.bars, ctx)
...
def test_geometry_extras_richness():
    ...
    for key in ("setup_count", "td_perfection", "bar9_low", "bar9_high",
                ...
                "tdst_support", "highest_high_in_setup"):
...
def test_confidence_formula_pin():
    """Pins the canonical 4-weight confidence formula for td_sequential_sell.
    ...
    assert d["confidence"] == expected, (
        ...
        "Check formula weights in detect_td_sequential_sell."
    )
