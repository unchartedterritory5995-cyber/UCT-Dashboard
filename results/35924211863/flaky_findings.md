...
| #342 → #343 | no | api/routers/auth.py is referenced by 774 source file(s); api/routers/journal_two.py is referenced by 469 source file(s); api/services/journal_two/ask_evidence.py is referenced by 22 source file(s) |
...
⛔ **10 of 240 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
