...
| #190 → #191 | no | api/services/ast_interpret.py is referenced by 89 source file(s); app/src/components/chart/engine/ast/closedTable.json is referenced by 164 source file(s); app/src/components/chart/engine/ast/interpret.js is referenced by 254 source file(s) |
| #191 → #20 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **11 of 131 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
