...
| #234 → #235 | no | api/services/screener/screener_universe.py is referenced by 4 source file(s); api/services/screener/snapshot_builder.py is referenced by 57 source file(s); api/services/screener/snapshot_db.py is referenced by 94 source file(s) |
| #235 → #24 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **10 of 168 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
