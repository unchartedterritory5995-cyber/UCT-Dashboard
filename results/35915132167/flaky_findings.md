...
| #340 → #35 | **UNREADABLE** | the diff 51a61a8b8..217ae7230 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 237 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
