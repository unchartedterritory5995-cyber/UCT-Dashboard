...
| #92 → #93 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
| #93 → #94 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |

⛔ **11 of 63 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
...
- `pytest` · `tests.test_mutation_check.TestRestoreGuarantee` · test_the_file_is_byte_identical_after_a_detected_mutation
- `pytest` · `tests.test_mutation_check.TestVerdicts` · test_expect_red_naming_the_right_test_passes
