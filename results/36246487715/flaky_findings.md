...
| #454 → #456 | no | api/main.py is referenced by 1204 source file(s); api/routers/discord_interactions.py is referenced by 66 source file(s); api/services/discord_interactions.py is referenced by 66 source file(s) |
...
⛔ **11 of 292 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
