...
| #37 → #370 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
| #370 → #38 | **UNREADABLE** | the diff a6dfa7d05..d25eddf49 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 255 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
