...
| #451 → #454 | **UNREADABLE** | the diff b43822d2f..f883e0996 is UNREADABLE (shallow checkout?) |
...
⛔ **11 of 290 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
