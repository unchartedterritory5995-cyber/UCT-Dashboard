...
| #393 → #398 | **UNREADABLE** | the diff 8452b14d8..24092c91d is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 259 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
