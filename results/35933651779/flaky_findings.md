...
| #345 → #35 | **UNREADABLE** | the diff 877dd173c..217ae7230 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 241 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
