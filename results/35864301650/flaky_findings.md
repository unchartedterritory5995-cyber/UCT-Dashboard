...
| #323 → #33 | **UNREADABLE** | the diff e8b3a8c20..026a6693f is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 226 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
