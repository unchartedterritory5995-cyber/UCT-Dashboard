...
| #214 → #215 | no | api/services/screener/query.py is referenced by 699 source file(s); app/src/pages/screener/FilterChips.jsx is referenced by 7 source file(s); app/src/pages/screener/shell/ScannerShell.jsx is referenced by 32 source file(s) |
| #215 → #22 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **10 of 150 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
