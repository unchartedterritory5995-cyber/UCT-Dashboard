...
| #261 → #263 | no | app/src/components/NavBar.module.css is referenced by 2 source file(s); app/src/pages/screener/shell/FilterRail.jsx is referenced by 4 source file(s); app/src/pages/screener/shell/ScannerShell.jsx is referenced by 34 source file(s) |
...
⛔ **8 of 188 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
