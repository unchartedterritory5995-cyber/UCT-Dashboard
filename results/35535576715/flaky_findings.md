...
| #207 → #208 | no | api/services/ast_interpret.py is referenced by 90 source file(s); app/src/components/chart/engine/ast/closedTable.json is referenced by 165 source file(s); app/src/components/chart/engine/ast/interpret.js is referenced by 256 source file(s) |
| #208 → #21 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **11 of 144 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
