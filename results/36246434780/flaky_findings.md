...
| #454 → #455 | **UNREADABLE** | whether "docs/notebook/user-study/study-notebook/Research/CRWD research \342\200\224 endpoint security.md" is referenced is UNREADABLE |
| #455 → #456 | **UNREADABLE** | whether "docs/notebook/user-study/study-notebook/Research/CRWD research \342\200\224 endpoint security.md" is referenced is UNREADABLE |
...
⛔ **11 of 293 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
