...
| #354 → #36 | **UNREADABLE** | the diff 451aed688..d25a84ae4 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 248 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
