...
| #320 → #33 | **UNREADABLE** | the diff ecdfef01e..026a6693f is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 223 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
