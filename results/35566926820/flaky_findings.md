...
| #230 → #24 | **UNREADABLE** | the diff 0cd80feca..16027f239 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 164 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
