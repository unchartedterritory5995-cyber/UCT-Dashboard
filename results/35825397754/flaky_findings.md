...
| #322 → #33 | **UNREADABLE** | the diff bab3f8b5c..026a6693f is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 225 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
