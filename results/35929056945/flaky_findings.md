...
| #341 → #343 | **UNREADABLE** | the diff 475fe1699..e2ca7407f is UNREADABLE (shallow checkout?) |
| #343 → #35 | **UNREADABLE** | the diff e2ca7407f..217ae7230 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 239 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
