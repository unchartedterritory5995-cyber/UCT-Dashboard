...
| #232 → #234 | **UNREADABLE** | the diff be66e9031..7ac9ff5ce is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 166 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
