...
| #320 → #321 | no | app/src/pages/screener/shell/ColumnPicker.jsx is referenced by 4 source file(s); app/src/pages/screener/shell/PresetChips.jsx is referenced by 2 source file(s); app/src/pages/screener/shell/ScannerShell.module.css is referenced by 14 source file(s) |
| #321 → #33 | **UNREADABLE** | the diff 6ec3ebf1e..026a6693f is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 224 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
