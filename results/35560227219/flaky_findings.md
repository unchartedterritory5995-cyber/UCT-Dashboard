...
| #225 → #226 | no | app/src/pages/screener/shell/ScannerShell.module.css is referenced by 10 source file(s); app/src/pages/screener/shell/UniverseBar.jsx is referenced by 3 source file(s) |
| #226 → #23 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **9 of 160 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
