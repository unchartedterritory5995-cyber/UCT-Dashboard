...
| #356 → #357 | no | Dockerfile.web is referenced by 10 source file(s); app/src/components/chart/builder/memberPane/memberPaneDefinition.js is referenced by 21 source file(s); app/src/components/chart/builder/memberPane/objectsOnlyAnchorMode.test.js is referenced by 1 source file(s) |
| #357 → #36 | **UNREADABLE** | the diff aea50bf2e..d25a84ae4 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 251 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
