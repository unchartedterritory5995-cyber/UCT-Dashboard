...
| #447 → #448 | no | api/main.py is referenced by 1180 source file(s); api/routers/client_errors.py is referenced by 7 source file(s); api/routers/journal_two.py is referenced by 521 source file(s) |
| #448 → #45 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **12 of 287 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
