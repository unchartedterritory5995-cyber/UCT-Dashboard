...
| #318 → #319 | no | app/src/pages/screener/shell/FilterRail.jsx is referenced by 4 source file(s); app/src/pages/screener/shell/PresetChips.jsx is referenced by 2 source file(s); app/src/pages/screener/shell/ScannerShell.jsx is referenced by 36 source file(s) |
| #319 → #32 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **10 of 222 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
