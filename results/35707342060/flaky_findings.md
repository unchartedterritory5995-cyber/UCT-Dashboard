...
| #263 → #264 | no | app/src/components/ui/UIcon.jsx is referenced by 375 source file(s); app/src/pages/screener/shell/SaveScanButton.jsx is referenced by 2 source file(s); app/src/pages/screener/shell/ScannerShell.jsx is referenced by 35 source file(s) |
| #264 → #27 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **8 of 190 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
