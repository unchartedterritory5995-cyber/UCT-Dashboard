...
| #340 → #341 | no | api/routers/auth.py is referenced by 775 source file(s); api/routers/journal_two.py is referenced by 473 source file(s); api/services/journal_two/ask_evidence.py is referenced by 31 source file(s) |
| #341 → #35 | **UNREADABLE** | the diff 475fe1699..217ae7230 is UNREADABLE (shallow checkout?) |
...
⛔ **10 of 238 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
