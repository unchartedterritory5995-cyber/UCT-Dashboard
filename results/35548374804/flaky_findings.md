...
| #218 → #219 | no | app/src/components/chart/engine/ast/pine.js is referenced by 360 source file(s); tools/corpus_metric.json is referenced by 6 source file(s) |
| #219 → #22 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **10 of 154 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
