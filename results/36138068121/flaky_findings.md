...
| #404 → #407 | no | app/src/components/chart/builder/BuilderSheet.pine.test.jsx is referenced by 2 source file(s); app/src/hub/rule12Paths.test.js is referenced by 10 source file(s); app/src/pages/OptionsFlow.jsx is referenced by 73 source file(s) |
| #407 → #41 | **UNREADABLE** | .github/workflows/clock-parity-fixture.yml is UNREADABLE at one of the two commits |
...
⛔ **10 of 266 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
