...
| #192 → #194 | no | api/services/ast_interpret.py is referenced by 89 source file(s); api/services/screener/filters.py is referenced by 367 source file(s); api/services/screener/query.py is referenced by 698 source file(s) |
| #194 → #196 | **UNREADABLE** | the diff 9daa6e131..eac4dd3a8 is UNREADABLE (shallow checkout?) |
| #196 → #20 | **UNREADABLE** | the diff eac4dd3a8..03ebbd7f7 is UNREADABLE (shallow checkout?) |
...
⛔ **11 of 134 consecutive pairs were comparable.** A pair that is not comparable contributes NO evidence in either direction — it cannot make a test flaky and it cannot clear one.
