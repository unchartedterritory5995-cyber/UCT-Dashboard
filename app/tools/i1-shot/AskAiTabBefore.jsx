// ⚠️ SCREENSHOT HARNESS ONLY — a verbatim copy of AskAiTab.jsx as it stood at the
// GATE-I1 slice-2 merge base, kept so the BEFORE screenshot is a real render of
// the real pre-fix component and not a mock-up of one. The ONLY edit is the
// stylesheet import path (this file sits outside app/src). Do not import it
// from anything but tools/i1-shot/main.jsx.
import { useState, useEffect, useRef } from 'react'
import styles from '../../src/pages/research/ResearchPage.module.css'
