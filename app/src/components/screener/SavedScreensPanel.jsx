...
import { SCAN_TF, defaultSession, scannableScreens } from './scanSession'
import styles from './SavedScreensPanel.module.css'

// The session vocabulary (`SESSION_TZ`, `SCAN_TF`, `defaultSession`,
// `scannableScreens`) moved to `./scanSession` (Task 6 of the E-4 unification
// plan) so `pages/screener/ScreensManager.jsx` can use it without importing
// this panel. Re-exported here VERBATIM so the scanmount rail's existing
// import source stays valid until this panel is deleted (Task 7).
export { SESSION_TZ, SCAN_TF, defaultSession, scannableScreens } from './scanSession'
