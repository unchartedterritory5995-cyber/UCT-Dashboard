...
describe('R-19 — the action is back, and the ring is still legal', () => {
  ...
  it('⛔ RING LEGALITY after the return — outer 4, inner 4, both within the caps', () => {
    renderHub()
    ...
    // ⚰️ WAS THREE. `notebook.voiceNote` (D-17) joined the same ring from another branch in
    // this increment; four is still within OUTER_MAX 5. The list is spelled out on purpose —
    // see the same assertion in linkTickerWritesTheNote.test.jsx.
