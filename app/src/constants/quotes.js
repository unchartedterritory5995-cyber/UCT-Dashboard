...
// Extracted from FuturesStrip so the Dashboard status bar and the mobile
// futures strip share one source (and one date-seeded pick).
...
// (97 is coprime to the library length so all quotes are reached before repeat).
