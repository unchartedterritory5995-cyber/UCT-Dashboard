        ...
        {tab==="Market Read" && (
          <div style={{ marginBottom:12 }}>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:0, background:P.cd, border:"1px solid "+P.bd, borderRadius:marketNarrative&&!narrativeLoading?"10px 10px 0 0":10, padding:"8px 14px", flexWrap:"wrap" }}>
              ...
              {marketIndices && (
                <button onClick={fetchMarketData} title="Refresh" style={{ marginLeft:"auto", padding:"2px 8px", borderRadius:3, border:"1px solid "+P.bl, background:"transparent", color:P.dm, fontSize:9, cursor:"pointer", fontFamily:"inherit", flexShrink:0 }}>↻</button>
              )}
            </div>
            {/* AI Narrative */}
            {narrativeLoading && (
