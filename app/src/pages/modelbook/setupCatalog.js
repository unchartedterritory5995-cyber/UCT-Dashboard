...
//               line at that candle's high/low/close.
//   trend     — optional { from, to, side: 'h'|'l' }: DIAGONAL dashed trendline
//               through two candles' highs/lows.
//               Both line types extend rightward and stop at the leading edge
//               of the final trigger candle (never through it).
...
export const SETUP_CATALOG = [
  ...
  // ── Momentum & Trend ───────────────────────────────────────────────────────
  {
    ...
    candles: [2, 3.5, 2.5, 3, -1.2, -1.5, -1, [1, 0.3, 0.3], 4.5, [3, 0, 0.3]],
    emas: [9, 20],
  },
  {
    name: 'EMA Crossback',
    ...
    candles: [-2, -2.5, -2, -1.5, 5, 4.5, -1.5, [-1, 0.3, 0.8], 4, [3.5, 0, 0]],
    emas: [9, 20],
  },
  {
    name: 'Wedge Pop',
    ...
    candles: [-4, -4.5, -3.5, 3, 2.5, -0.8, -0.7, -0.6, 6.5, [3, 0, 0.3]],
    emas: [9, 20],
  },
  {
    name: 'Wedge Drop',
    ...
    candles: [4, 4.5, 3.5, -3, -2.5, 0.8, 0.7, 0.6, -6.5, [-3, 0.3, 0]],
    emas: [9, 20],
  },
  ...
  },
  {
    ...
    candles: [-0.4, 0.6, 0.4, -0.5, 0.5, [9, 2, 0.6], -1.5, -1, 1.2, [5, 0, 0.4]],
    pivot: { idx: 5, side: 'h' },
  },
  {
  ...
  },
  {
    ...
    candles: [0.5, -0.4, 0.6, -0.5, 0.5, [8, 1, 0.4], -2, -1.4, [1, 0.4, 1.8], [5, 0, 0.3]],
    pivot: { idx: 5, side: 'l' },
  },
  {
    name: 'Kicker Candle',
  ...
  // ── Reversals & Reclaims ───────────────────────────────────────────────────
  {
    ...
    candles: [-1.5, -2, -1.8, -4, -3, -2.5, [-1.2, 0.5, 3.2], 4.5, 3.5, [5, 0, 0]],
    pivot: { idx: 5, side: 'l' },
  },
  {
    ...
    candles: [-1.2, -1.8, -2, -1.5, -2.5, [-1, 0.4, 3], 5, 3, 2, [3.5, 0, 0.3]],
    pivot: { idx: 4, side: 'l' },
  },
  {
    name: 'Slingshot',
    ...
    candles: [3, 4, 3.5, 3, -2.5, -2, -1.2, 0.5, [5, 0.6, 0.4], [3, 0, 0]],
    ema: 3,
  },
  {
    name: 'Oops Reversal',
    ...
    candles: [0.8, 1.2, 1.5, 1, -0.8, [-4, 3.2, 0.6], 4.5, 2.5, 2, [3, 0, 0.3]],
    pivot: { idx: 4, side: 'l' },
  },
  {
    name: 'Remount',
    ...
    candles: [2, 2.5, 3, 2.5, -2, -3, -1.5, 1, [5, 0.8, 0.4], [3.5, 0, 0]],
    ema: 4,
  },
  {
    ...
    candles: [1.5, 2, 3, -2.5, 4.5, -4, 2.5, -2, 1.5, [7, 0, 0.4]],
  },
  {
    name: 'Parabolic Long',
    family: 'Reversals & Reclaims',
    ...
    candles: [0.8, 1, 1.5, 2, 3, 4, 5.5, 7.5, 10, [13, 0, 0.5, 1.2]],
  },
  {
    ...
    candles: [1.5, 2, 3, 4.5, 7, 10, 13, [-3, 4, 1], -11, [-7, 0.4, 0]],
    pivot: { idx: 7, side: 'l' },
    ema: 5,
  },
  ...
  // ── Intraday ───────────────────────────────────────────────────────────────
  {
    ...
    candles: [2.5, -1.8, 1.2, -0.8, 1, -0.6, 0.8, 6, 2.5, [4, 0, 0.3]],
    pivot: { idx: 0, side: 'h' },
  },
  {
    ...
    candles: [3, -1, 0.5, -0.6, 0.4, -0.3, 0.5, -0.4, 5.5, [3, 0, 0]],
    pivot: { idx: 0, side: 'h' },
  },
  {
    name: 'Go Signal',
    ...
    candles: [0.4, -0.3, 0.5, [8, 1, 0.4], -1.5, -1.2, -1, [7.5, 0.6, 0.3], 2, [3, 0, 0.3]],
    ema: 4,
    pivot: { idx: 3, side: 'h' },
  },
]
