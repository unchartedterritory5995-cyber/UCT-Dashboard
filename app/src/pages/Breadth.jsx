...
const HM_METRICS = [
  ...
  { key: 'magna_up',        label: 'MAGNA Up',      group: 'Primary',
    getTier: r => pairedUpColor(r.magna_up, r.magna_down),
    getFmt:  r => r.magna_up ?? '—' },
  { key: 'magna_down',      label: 'MAGNA Dn',      group: 'Primary',
...
const TREEMAP_DEF = [
  { key: 'main', label: '', weight: 100,
    ...
    items: [
      { metricKey: 'breadth_score',   weight: 20 },
      { metricKey: 'uct_exposure',    weight: 15 },
      { metricKey: 'up_4pct_today',   weight: 13 },
      { metricKey: 'down_4pct_today', weight: 13 },
      { metricKey: 'spy_ma_stack',    weight: 14 },
      { metricKey: 'qqq_ma_stack',    weight: 14 },
      { metricKey: 'cnn_fear_greed',  weight: 11 },
    ],
  },
]
