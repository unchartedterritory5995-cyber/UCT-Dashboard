...
// Paid-only library of the firm's educational videos, organized by category.
...
export default function EducationalVideos() {
  ...
  const [editing, setEditing] = useState(null)   // {…video} or {} (new) when the form is open

  const categories = data?.categories || []
  const total = data?.total ?? 0

  // Client-side search across title / description / category.
