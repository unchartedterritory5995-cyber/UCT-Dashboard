...
test('move down reorders the draft and the PUT carries the new whole-list order; no PATCH when meta untouched', async () => {
  ...
  expect(bodyOf(puts[0]).steps).toEqual([
    { youtube_id: 'lib0000000b', module_label: null, note: null, start_seconds: null, end_seconds: null, planned_title: null, script: null },
    { youtube_id: 'lib0000000a', module_label: null, note: null, start_seconds: null, end_seconds: null, planned_title: null, script: null },
    { youtube_id: 'lts0000000a', module_label: null, note: null, start_seconds: null, end_seconds: null, planned_title: null, script: null },
  ])
...
test('add via the predictive library search + remove a lesson — the PUT reflects both, with inline module/note carried', async () => {
  ...
  expect(bodyOf(puts[0]).steps).toEqual([
    { youtube_id: 'lib0000000a', module_label: null, note: null, start_seconds: null, end_seconds: null, planned_title: null, script: null },
    { youtube_id: 'lts0000000a', module_label: null, note: null, start_seconds: null, end_seconds: null, planned_title: null, script: null },
    { youtube_id: 'lib0000000c', module_label: 'Risk', note: 'Size before entries.', start_seconds: null, end_seconds: null, planned_title: null, script: null },
  ])
})
...
test('an unresolvable step id is flagged in the editor and SURVIVES the round-trip', async () => {
  ...
  expect(bodyOf(puts[0]).steps).toEqual([
    { youtube_id: 'lib0000000c', module_label: null, note: null, start_seconds: null, end_seconds: null, planned_title: null, script: null },
    { youtube_id: 'zzUNKNOWNzz', module_label: 'Legacy', note: 'Re-record this one.', start_seconds: null, end_seconds: null, planned_title: null, script: null },
    { youtube_id: 'evn0000000a', module_label: null, note: null, start_seconds: null, end_seconds: null, planned_title: null, script: null },
  ])
})
