...
describe('preset set v2', () => {
  ...
  it('adds the seven new presets', () => {
    ...
    expect(CHART_PRESETS).toHaveLength(36)   // +20 added 2026-08-07
  })
  ...
  it('partitions cleanly into core pills and grouped popover entries', () => {
    ...
    // The core pill bar is the thing worth protecting: it must stay small
    // enough to scan. Everything added on 2026-08-07 went to the popover, so
    // core is unchanged at 7 while grouped grew 9 -> 29.
