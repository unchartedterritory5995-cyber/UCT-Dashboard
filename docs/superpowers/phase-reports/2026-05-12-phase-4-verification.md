...
**Date:** 2026-05-12T22:31:07.036988
**Overall:** WARN
...
| Check | Status | Result |
|---|---|---|
| Test Suite | ✅ PASS | 992/992 passing (4.23s) |
| Detector Inventory | ✅ PASS | 50 detector(s) registered (0.32s) |
| Schema Integrity | ✅ PASS | all 4 tables + 4 indexes present (0.01s) |
| Live API Smoke | ✅ PASS | 3/3 endpoints OK (0.52s) |
| Fixture Batteries | ✅ PASS | 753/753 fixtures pass across 50 detector(s) (0.22s) |
| False-Positive Sweep | ⚠️  WARN | sweep across 2000 synthetic bars; median rate 0.00/1k; 1 flagged (0.08s) |
| Performance Bench | ✅ PASS | p99 latency across [200, 500, 1000]: 10.56ms, 17.09ms, 34.18ms (1.15s) |
...
992/992 passing (4.23s)

```
    return asyncio.iscoroutinefunction(func)

..\AppData\Roaming\Python\Python314\site-packages\fastapi\routing.py:233: 747 warnings
...
..\AppData\Roaming\Python\Python314\site-packages\starlette\_utils.py:39: 755 warnings
...
992 passed, 22290 warnings in 3.38s
...
50 detector(s) registered (0.32s)
...
753/753 fixtures pass across 50 detector(s) (0.22s)
...
p99 latency across [200, 500, 1000]: 10.56ms, 17.09ms, 34.18ms (1.15s)

| bar count | p50 (ms) | p95 (ms) | p99 (ms) | target | result |
|---|---|---|---|---|---|
| 200 | 10.04 | 10.56 | 10.56 | <100.0ms p99 | ✅ |
| 500 | 15.27 | 17.09 | 17.09 | <100.0ms p99 | ✅ |
| 1000 | 31.79 | 34.18 | 34.18 | <200.0ms p99 | ✅ |
