...
**Date:** 2026-05-12T23:32:42.000106
**Overall:** WARN
...
| Performance Bench | ✅ PASS | p99 latency across [200, 500, 1000]: 10.35ms, 15.08ms, 30.85ms (1.06s) |
...
| Launch Readiness | ⚠️  WARN | PRE-LAUNCH (showPatterns default OFF) — 1 issue(s) (0.00s) |

## Details

### ✅ Test Suite — PASS

1011/1011 passing (4.32s)
...
1011 passed, 24163 warnings in 3.61s
...
p99 latency across [200, 500, 1000]: 10.35ms, 15.08ms, 30.85ms (1.06s)

| bar count | p50 (ms) | p95 (ms) | p99 (ms) | target | result |
|---|---|---|---|---|---|
| 200 | 9.42 | 10.35 | 10.35 | <100.0ms p99 | ✅ |
| 500 | 13.6 | 15.08 | 15.08 | <100.0ms p99 | ✅ |
| 1000 | 29.58 | 30.85 | 30.85 | <200.0ms p99 | ✅ |
...
PRE-LAUNCH (showPatterns default OFF) — 1 issue(s) (0.00s)
...
- Detector count: **50** ✅ (catalog complete)
