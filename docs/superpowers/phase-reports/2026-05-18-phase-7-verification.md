...
**Date:** 2026-05-18T21:15:58.814613
**Overall:** WARN
...
| Check | Status | Result |
|---|---|---|
| Test Suite | ✅ PASS | 1725/1725 passing (6.06s) |
| Detector Inventory | ✅ PASS | 85 detector(s) registered (0.28s) |
| Schema Integrity | ✅ PASS | all 4 tables + 4 indexes present (0.04s) |
| Live API Smoke | ⚠️  WARN | skipped (--skip-api) (0.00s) |
| Fixture Batteries | ✅ PASS | 1290/1290 fixtures pass across 86 detector(s) (0.36s) |
| False-Positive Sweep | ⚠️  WARN | sweep across 2000 synthetic bars; median rate 0.00/1k; 1 flagged (0.11s) |
| Performance Bench | ✅ PASS | p99 latency across [200, 500, 1000]: 13.25ms, 16.98ms, 53.81ms (1.64s) |
...
1725 passed, 50963 warnings in 5.20s
...
85 detector(s) registered (0.28s)
...
1290/1290 fixtures pass across 86 detector(s) (0.36s)
...
sweep across 2000 synthetic bars; median rate 0.00/1k; 1 flagged (0.11s)
...
p99 latency across [200, 500, 1000]: 13.25ms, 16.98ms, 53.81ms (1.64s)

| bar count | p50 (ms) | p95 (ms) | p99 (ms) | target | result |
|---|---|---|---|---|---|
| 200 | 12.38 | 13.25 | 13.25 | <100.0ms p99 | ✅ |
| 500 | 16.33 | 16.98 | 16.98 | <100.0ms p99 | ✅ |
| 1000 | 52.97 | 53.81 | 53.81 | <200.0ms p99 | ✅ |
