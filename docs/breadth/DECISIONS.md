...
proving the moved assertion still fails when the expectation is inverted. Scope: the brief's off-limits list is Notebook
product files and `OptionsFlow.jsx`; this is neither, and it is test-only.
