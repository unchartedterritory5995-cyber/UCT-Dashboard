...
**Unweighted average across the 16 domains above: ~5.0 / 10** (was 4.9; Trust/
Recovery and Export/Portability each +1, Wave C, 2026-09-06 — see their rows above).
...
3. Ship internal links / backlinks / knowledge relationships (Wave D, in progress) —
   the most important remaining generic-notebook-parity gap versus Notion/Obsidian
   (Knowledge Linking domain, currently scored 3).
4. Ship the fact/snapshot ledger + analyst-estimates capture path — unlocks Thesis
   ...
   dependency graph). Now sequenced AFTER Wave D per the current roadmap.
