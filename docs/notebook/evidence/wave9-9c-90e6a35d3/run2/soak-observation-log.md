...
|---|---|---|---|---|---|---|---|---|
| 2026-09-26 00:08 ET | 2026-09-26 04:08:40 · organic 2 · synthetic 0 · rig/owner 0 · ⛔ UNKNOWN INTERNAL 1 | 2 | 0/0 — no member reported | 1 | 0 | 0 | 0 | OK (SANDBOX exercise of the observer's reads; not a production row) |
