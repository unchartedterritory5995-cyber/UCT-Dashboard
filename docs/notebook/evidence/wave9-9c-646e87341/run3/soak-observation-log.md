...
|---|---|---|---|---|---|---|---|---|
| 2026-09-26 00:35 ET | 2026-09-26 04:35:30 · organic 3 · synthetic 0 · rig/owner 0 · ⛔ UNKNOWN INTERNAL 1 | 6 | 0/0 — no member reported | 2 | 0 | 0 | 0 | OK (SANDBOX exercise of the observer's reads; not a production row) |
