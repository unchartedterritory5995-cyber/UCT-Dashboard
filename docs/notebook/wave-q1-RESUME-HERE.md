...
⛔ **REGENERATED BY `tools/window_check.py` ON EVERY RUN — as of check 11 — 2026-09-11T00:30:59Z.**
...
| 2 | Opted-in browsers (the denominator) | **16** — need ≥ **5** |
| 3 | Consecutive green daily runs, mini-canary all steps | **8** — need **7** |
| — | Has a 🚨 NEW FINDING ever fired? | **no** |

## ✅ RECOMMENDATION: **GO**

**Met:** zero blocked-baseline events · 16 opted-in browsers · 8 consecutive green runs
