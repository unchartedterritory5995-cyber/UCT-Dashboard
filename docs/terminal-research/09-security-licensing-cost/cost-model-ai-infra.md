...
**OBSERVATION.** At base assumptions, the six AI features the program is likely to propose cost **$2.8–3.6 per member per month** at 1,000–10,000 members and **$7.27** at 100 (fixed warm lanes dominate small populations), on top of a **fixed base of ~$515/month** that already runs today (Anthropic only, MEASURED second-hand). Against the OI-12 default ARPU of **$200/month list** that is **1.4–3.6%** of revenue. Against the comparable-floor ARPU of **~$30/month** (⚰️ **"the seed's $7 weekly promo" is STRUCK from this list, 2026-09-26 — CARD 23: it is the **Whop** plan's price, a SEPARATE product, and was never this product's ARPU. UCT Intelligence is owner-ratified at **$200/month or $2,000/year**. The floor keeps its two genuine competitor supports below and stands as a COMPETITOR comparable — never again as UCT's own price.** Benzinga Basic $30.58, Unusual Whales Basic $34 annual-effective) the base case is **9–24%**, and the **high case ($23.5/member/month all-in, inherited Compass and voice included) is 78%** — the crossover sits at roughly **1.3× the high case, or ~4.5× base engagement, at a $30 ARPU**; at $200 it sits at ~32× base engagement. **The per-user caps already in code do not prevent that crossover: summed, they permit ~$600–650 per member per month — three times the list price** — and the only lane that bounds a population today is a lane-level daily dollar cap, of which the chattiest member lane (Compass chat) has none (`COMPASS_COST_CAP_DAILY` default `0` = disabled).
