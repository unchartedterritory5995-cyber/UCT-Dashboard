...
Internal desk first, members second (D-001). US equities primary; options active; indices/ETFs context; futures positioning as a research rail; no FX, fixed income, or crypto in V1. No execution or order management. No public Substack wire. No renaming of persisted preference or widget keys. Under ~750 community members; one paid tier with a $7 weekly promo. ⚰⚰ **CORRECTED 2026-09-26 (CARD 23) — THAT CLAUSE SPLICES TWO PRODUCTS.** The **one paid tier** half is right and is UCT Intelligence's, priced **$200/month or $2,000/year** (owner-ratified; `Pricing.jsx` docstring, 2026-07-11 premium reposition). The **$7 weekly promo is the Whop plan** — a separate live-trading-Discord product promoted through the wire's Substack (`morning-wire/substack/promo.py`: *"The Whop plan is one WEEK for $7"*). ✅ **AND THE ~750 FIGURE IS NOW IDENTIFIED (CARD 25, owner 2026-09-26): "We have 750 members in discord paying" — PAYING DISCORD MEMBERS, i.e. the Whop product's population.** ⛔ It is NOT UCT Intelligence's, which is ~26 accounts with **13** carrying any page-view row and six of the roster admins. **Two products, two populations — never one denominator.** ⭐ And it is the subject pool CARD 22's definition-of-done blocker was assumed to lack. CORRECTED 2026-09-02 (DL-010): the code makes the Morning Wire the ONLY free page (`AuthGuard.jsx` `FREE_PAGES = ['/morning-wire']`) and paid-gates every other route server-side; the seed facts had this inverted. Proceeding on the code; owner confirmation requested (OI-12). 2–5 internal dogfooders. Desk tools today: thinkorswim/Schwab, TradingView, Finviz, Discord, Substack, YouTube.
...
## 14A. THE EXISTING DATA ARSENAL, NOT JUST MASSIVE/FMP (owner directive, DL-022)

Before recommending, architecting around, or costing ANY new external data vendor, API, dataset, or paid service, the program must first exhaust what UCT already has. This is not a new principle -- Document B section 15 already required it -- but the owner has directed that the audit be structurally complete, not implicitly narrowed to the two providers (Massive, FMP) that happen to drive the licensing math. The canonical artifact is the PROVIDER MASTER LEDGER (superseding `02-data-providers/provider-ledger.md` once F-09 lands, per DL-022): every provider across all six code locations, with a full per-asset-class capability matrix (quotes, historical, streaming, fundamentals, statements, estimates, earnings, transcripts, filings, news, macro, options, ownership/insiders, corporate actions, calendars/events, alternative data, search/reference/symbol) and the A-G status taxonomy: **A** currently used, **B** configured but underutilized, **C** available through a current provider but not yet consumed, **D** duplicative/overlapping, **E** legacy/dormant, **F** licensing unknown, **G** missing from the current stack entirely. The B/C-vs-G distinction is load-bearing: never recommend a new vendor for a capability the ledger has not first confirmed is class G.
