...
- **S9** → CP1 DONE, 2026-09-19. OI-03(a)(b), OI-12 and OI-09 now ANSWERED (Massive CONFIRMED Business/Enterprise — correcting a same-day earlier tentative answer — FMP DDLA confirmed, paid-only model confirmed, and UCT confirmed staying downstream/not a vendor of record). **CP2 scoped proposal DRAFTED 2026-09-19** (gate packet §8): reading the 30 unlocked rows individually found 19 already LIVE (zero member-visible effect — Business tier retroactively authorizes what members already see) and 11 unbuilt TERMINAL-NEXT candidates (also zero effect, only unblocked for a future proposal); sitting on a blank approval block, awaiting owner sign-off. 8 of the 38 rows stay U on FOUR distinct facts, not two (ESC-05 covers 5; ESC-14 covers N-19 alone; ESC-21+OI-03(d) covers T-20 alone; **T-31 alone — MEASURED AND FIXED 2026-09-19: the 15-min lag was not enforced, a fix is written and pushed to `feat/s7-price-level` (`2c6f4cd7e`), NOT YET merged/deployed**) — six of those eight are LIVE TODAY with unresolved licensing status, flagged as separate and more urgent than CP2 itself — see the S9 row, §1.1
...
| **S9** Entitlements | ✅ **CP1 SIGNED AND BUILT** (2026-09-19) — the entitlement axis enumerated from source as inert data, plus two mechanical fixes (Login.jsx trial-routing bug, FREE_PAGES triplication) | — | ⚰️⚰️ **OI-03(a)/(b), OI-12 and OI-09 all ANSWERED BY THE OWNER 2026-09-19** (not the blanket "we have all licensing and approval" statement itself, which was asked back precisely and answered per-question). **(a) Massive tier: CONFIRMED Business/Enterprise, already held** — this corrects, same day, an earlier and more tentative owner statement ("beta phase, commercial upgrade planned but not yet in place"); a direct check afterward found Business was already in force. **(b)** FMP DDLA confirmed to exist (15 of 19 FMP-gated licensing-register rows move R→LA). **(c) paid-only model** confirmed matching current code exactly. **OI-09/OI-E02-09: UCT CONFIRMED staying downstream** — not a vendor of record; N-26's attestation machinery is deliberately not built. **CP2 SCOPED PROPOSAL DRAFTED 2026-09-19** (gate packet §8): reading the 30 unlocked rows individually rather than as a count found 19 already LIVE (zero member-visible effect — Business tier retroactively authorizes what members already see) and 11 unbuilt TERMINAL-NEXT candidates (also zero effect today; only unblocked for a future, separate proposal) — CP2 is a documentation-only checkpoint, no code/flag/schema change, sitting on a **blank approval block awaiting owner review**, not yet signed. **8 of the 38 rows stay U on FOUR distinct facts, corrected from an earlier two-ESC-id shorthand**: ESC-05 (T-23, T-24, T-25, N-07, N-08 — does Massive's own agreement name OPRA display and pay the $1,500/mo floor); ESC-14 (N-19 alone — alert display vs. non-display use); ESC-21+OI-03(d) (T-20 alone — paid-Substack Edge User + signed addenda); **T-31 alone — its code measurement WAS TAKEN 2026-09-19: the ≥15-min lag was not enforced, and a fix is now written, tested, and pushed to `feat/s7-price-level` (`2c6f4cd7e`), but NOT YET merged to master or deployed, so production still runs the unfixed behavior.** **Six of those eight are LIVE TODAY with unresolved licensing status** (T-20, T-23, T-24, T-25, T-31, N-19's underlying feature) — §8.3 flags this as separate from CP2 and more urgent: one email to Massive covers ESC-05+ESC-14 together, T-20 needs a second narrower one, and T-31 needs only a merge and a deploy. | **BLOCKED-SPEC-READ** — the proposal is written and awaits owner review/sign-off, not further spec work |
