...
date: 2026-09-21
measured_against: "counts and cited SHAs re-derived 2026-09-21 against origin/master @ a392afd11; per-row prose last measured 2026-09-20 (⚰️ this said: origin/master @ f3109e1af · docs @ 8cbd6ec56, dated 2026-09-12)"
---
...
| **BLOCKED-SPEC-READ** | **1** | **A14** (moved from BLOCKED-OWNER 2026-09-20 — see below) — has a CP1 proposal drafted, unsigned. ⚰️ **A12 moved to DONE 2026-09-21**, its CP1 signed and built |
...
**Unique-system arithmetic, so the 32 is checkable, not asserted:** 24 DONE + 1 RULED-HOLD (S7)
+ 1 BLOCKED-DATA (D2) + 1 BLOCKED-OWNER-only (A9) + 1 BLOCKED-SPEC-READ (A14) + 2 single-tag
BLOCKED-DEPENDENCY (S8, A1) + 2 dual-tagged OWNER+DEPENDENCY (A11, A13, each counted once
here) = 24+1+1+1+1+2+2 = **32**. The breakdown table's BLOCKED-OWNER (3 = A9 + the 2 dual-tagged)
...
DONE. DONE count moved 22 → 23 (A10) → **24** (A12), all the same day. See F-AUDIT-3's own row
(§3.1c) for the A10/D3/D4 history; A12's move is a separate, unrelated signature.
