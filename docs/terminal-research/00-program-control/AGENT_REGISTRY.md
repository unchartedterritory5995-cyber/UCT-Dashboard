...
| F-06 | 2 | KILLED by 429 (nothing written); RE-DISPATCHED 16:10 (Fable) | 14:15 / 16:10 | — | — | `contracts/F-06.md` |
| F-08 | 2 | KILLED by 429 (nothing written); RE-DISPATCHED 16:10 (Fable) | 14:15 / 16:10 | — | — | `contracts/F-08.md` |
...
| B-POD-BBG | 2 | PARTIAL at the 429 (63 KB, no GAPS/SOURCES); COMPLETION re-dispatched 16:10 (Fable) | 13:00 / 16:10 | — | — | `bloomberg/dossier.md` |
...
| C5-02 | 2 | dispatched (Opus) | 2026-09-02 17:35 | — | — | personalization patterns; `contracts/C-WAVE2.md` §C5-02 |
...
| C7-03 | 2 | dispatched (Opus) | 2026-09-02 17:05 | — | — | vendor abstraction / data platform; `contracts/C-WAVE2.md` §C7-03 |
...
| B-POD-GDL | 2 | dispatched (Fable) | 2026-09-02 17:45 | — | — | Gödel dossier (gate item 8); `contracts/B-POD-GDL.md` (contract written 17:48 after a shell-encoding failure; the agent reads the preambles first, so the file existed before it was needed, to be verified on return) |
...
| C2-01 | 2 | dispatched (Opus) | 2026-09-02 17:25 | — | — | news architecture patterns; `contracts/C-WAVE2.md` §C2-01 |
...
| C2-02 | 2 | dispatched (Opus) | 2026-09-02 17:10 | — | — | events intelligence; `contracts/C-WAVE2.md` §C2-02 |
