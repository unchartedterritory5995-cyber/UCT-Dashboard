...
| Tools available to delegated agents | Bash, PowerShell, Read/Write/Edit, Glob/Grep, WebSearch (works), WebFetch (works on resolvable hosts; the probe URL `help.koyfin.com` does not resolve — DNS, not a block; `https://www.koyfin.com/` fetched fine), browser MCP `mcp__claude-in-chrome__*` (22–28 deferred tools; usable for authenticated or JS-rendered pages), Agent (nested) | PROBE reports |
...
| Usage-limit behavior | Not yet observed. Expected on a subscription seat; `RESUME.md` is the continuation mechanism. | — |
...
| E-02 | 1b | dispatched | 2026-09-02 08:00 (Opus) | — | — | internal-only synthesis of E-01/E-03/E-04/D-03/D-12/D-13; `contracts/E-02.md` |
| F-03a | 2 | dispatched | 2026-09-02 08:00 (Fable) | — | — | system map + capability ledger + tech-debt register; `contracts/F-03a.md` |
| F-03b | 2 | dispatched | 2026-09-02 08:00 (Fable) | — | — | provider ledger; `contracts/F-03b.md` | 2026-09-02 06:20 (batch 2, Opus; 17 in flight = measured step-up, DL-008) | — | — | contracts on disk |
