...
status: Step 1 IMPLEMENTED 2026-09-02 (§0a) against accepted D1 + its provenance/freshness hardening pass; the material freshness-enum item (§7.2a) is RESOLVED by owner decision; two open, non-blocking questions remain; awaiting owner sign-off before Step 2+
date: 2026-09-02
