...
merges-after: E CP23
status: SIGNED (E CP24, fingerprint c9904433a)
---
...
APPROVED AT SHA:  c9904433a
SCOPE APPROVED:   CP24 ONLY — the checkpoint(s) named here and nothing else in the packet.
```
