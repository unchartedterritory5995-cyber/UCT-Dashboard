...
| S-D golden gate / drift / smaller-model trial | `data\wisdom\extract\spend-ledger.json`, `data\wisdom\extract\pilot\gate-report-*.json` | $4.453353 of the $15 cap spent; batches `msgbatch_01Kvf7Q9ZinucRR7xfKQTsnq` (2 requests) and `msgbatch_019NjdbTHu1eK3MXbW2zxMC7` (30 requests) submitted AND collected | Continue within the S-D stream relaunch. Rebuild the remaining phases from the pilot reports and receipts, and pass `--max-usd` equal to the remaining cap (15 − 4.45). Never re-submit a batch already listed in the ledger. |
