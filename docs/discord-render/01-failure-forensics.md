...
| **C-13** | A credential in logs | 142 renderer call logs with the render token | 2.3 renderer log hygiene · OI-13 rotation | 🟡 **PARTLY CLOSED** — the renderer log hygiene shipped in 2.3; **OI-13, the token rotation, is the owner's** and is not this programme's to close |
