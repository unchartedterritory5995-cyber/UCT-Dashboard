...
| **C-09** | The warm cycle competes with members for the renderer | 4,785 over-budget cycles; ~3,300 renders/day | 2.1 background lane · 2.3 renderer background slots | 🔴 **OPEN** — the background lane exists; nothing measures that the warm cycle yields to members under load. Needs 3.1 `--real`. |
