...
## Master build plan, v1.3 (Wave 0 + Wave 0.5 gate decisions applied)

Supersedes v1.2. Every change is a gate decision or a correction forced by
`10-wave0-discovery.md` / `20-wave05-ux.md`. Where a decision and a discovered fact disagree, the
decision is applied as closely as the codebase allows and the gap is marked **⚠️**.
