...
| wire | `wire.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| breadth | `breadth.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| scan | `scan.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| chart | `chart.compare` “Compare” | run | outer | yes |  | chart | ? | sections/chartSection.js:201 |  |
| chart | `chart.logTrade` “Log trade” | run | inner | yes |  | symbol | ? | sections/chartSection.js:202 |  |
| chart | `chart.note` “Note” | run | inner | yes |  | symbol | ? | sections/chartSection.js:189 |  |
| chart | `chart.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| journal | `journal.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| catalysts | `catalysts.chartIt` “Chart it” | navigate → chart | outer | yes |  | symbol | — (route only) | sections/catalystsSection.js:87 |  |
| catalysts | `catalysts.flag` “Flag” | run | outer | yes |  | symbol | ? | sections/catalystsSection.js:102 | **newly reachable** |
| catalysts | `catalysts.why` “Why?” | navigate → /ai-search | outer | yes |  | symbol | — (route only) | sections/catalystsSection.js:94 |  |
| catalysts | `catalysts.filter` “Filter” | run | inner | yes |  |  | ? | sections/catalystsSection.js:115 |  |
| catalysts | `catalysts.note` “Note” | run | inner | yes |  | symbol | ? | sections/catalystsSection.js:109 | **newly reachable** |
| catalysts | `catalysts.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| notebook | `notebook.dailyPlan` “Daily plan” | navigate → /journal/notebook?new=daily-prep | inner | yes |  |  | — (route only) | — |  |
| notebook | `notebook.postMortem` “Postmortem” | navigate → /journal/notebook?new=trade-review | inner | yes |  |  | — (route only) | — |  |
| notebook | `notebook.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| calendar | `calendar.macro` “Macro” | run | outer | yes |  |  | ? | sections/calendarSection.js:64 |  |
| calendar | `calendar.myNames` “My names” | navigate → /calendar/mystocks | outer | yes |  |  | — (route only) | — |  |
| calendar | `calendar.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
...
| home | `home.calendar` “Calendar” | navigate → calendar | inner | yes |  |  | — (route only) | — |  |
| home | `home.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
| **flow** | _mode_ · /options-flow · chip “navigate only” · — none — | | | | | | | — no controller — |  |
| flow | `flow.voice` “Voice” | run | inner | yes |  |  | ? | HubRoot.jsx:189 |  |
