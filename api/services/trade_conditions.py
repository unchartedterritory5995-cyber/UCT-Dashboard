...
FILTER_ENABLED = os.environ.get("TRADE_CONDITION_FILTER_ENABLED", "1") == "1"
...
#
#   updates_high_low = FALSE (don't extend the developing bar's high/low):
#     2  Average Price Trade      7  Cash Sale            10 Derivatively Priced
#     12 Form T (extended hrs)    13 Ext-hrs Sold OOS     15 MC Official Close
#     16 MC Official Open         20 Next Day             21 Price Variation
#     22 Prior Reference Price    29 Seller               32 Sold (Out of Seq)
#     33 Sold (Out of Seq)        37 Odd Lot Trade        38 Corrected Consol Close
#     46 Contingent Trade         52 Contingent Trade     53 Qualified Contingent
_HL_INELIGIBLE_FALLBACK = frozenset(
    {2, 7, 10, 12, 13, 15, 16, 20, 21, 22, 29, 32, 33, 37, 38, 46, 52, 53}
)
...
_LAST_INELIGIBLE_FALLBACK = frozenset(
    {2, 7, 10, 12, 13, 20, 21, 22, 29, 30, 32, 33, 37, 46, 52, 53}
)

_lock = threading.Lock()
_hl_ineligible: set[int] = set(_HL_INELIGIBLE_FALLBACK)
_last_ineligible: set[int] = set(_LAST_INELIGIBLE_FALLBACK)
