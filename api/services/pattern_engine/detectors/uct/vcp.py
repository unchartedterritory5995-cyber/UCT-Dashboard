...
# structure `vcp`. Both are LIVE on different member surfaces: the catalog
...
# names: both 3, structure-only 12, engine-only 85 -- 3% agreement.
#
...
def _build_detection(bars, c, confidence, context,
    ...
    why_it_matters = (
        ...
        f"the supply at ${pivot_price:.2f} is finite and weakening. The {regime} regime adds further "
