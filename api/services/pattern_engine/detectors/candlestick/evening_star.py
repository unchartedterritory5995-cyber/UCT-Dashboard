...
def _build_detection(
    ...
    *,
    ...
    what_it_is = (
        ...
        f"puts evening-star reversal reliability at 72% — lower than the morning star's 78% "
        f"despite the shared three-bar geometry, though the evening star's overall performance "
        f"rank (4th of 103) is actually stronger than the morning star's (12th of 103) — when "
        f"all three bars meet his geometric criteria. Linda Raschke "
