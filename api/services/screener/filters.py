...
FILTERS = dict([
    ...
    _range("ps", "P/S", "fundamental", "ps",
           [{"label": "Any"}, {"label": "Under 4", "op": "lte", "max": 4},
            {"label": "Under 10", "op": "lte", "max": 10}]),
    ...
    _range("debt_to_equity", "Debt/Equity", "fundamental", "debt_to_equity",
           [{"label": "Any"}, {"label": "Low (<50)", "op": "lte", "max": 50},
            {"label": "Moderate (<100)", "op": "lte", "max": 100}]),
