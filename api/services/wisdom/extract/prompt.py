...
R2 LISTS: a bare list of tickers yields one MENTION per unique ticker. A ticker repeated in the list is emitted once. Put that ticker in ticker_as_written and the list as the quote; when the author defines what the list means, put that meaning in reason.
